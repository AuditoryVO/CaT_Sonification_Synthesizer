...
;2024
<Cabbage>
form caption("CaT Synth") size(835, 535), colour(255, 255, 255), pluginID("CaT Synth")
...
hslider bounds(552, 488, 122, 29) channel("Vibrato"), text("VIB"), range(0, 1, .5, 1, 0.001) trackercolour(0, 124, 207, 255) colour(204, 204, 204, 255)
...
gasendL= aFilt*gkEnv*kSend	;Reverb sends
...
a0 dust2 (k_mute*(1-gkr2))/80, kdens ;Accuracy sonification => random moise generator
